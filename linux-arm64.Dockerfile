...
RUN mkdir "${APP_DIR}/bin" && \
    curl -fsSL "https://github.com/danimart1991/Radarr/releases/download/${VERSION}/Radarr.${VERSION}.linux-core-arm64.tar.gz" | tar xzf - -C "${APP_DIR}/bin" --strip-components=1 && \
